...
const projects = [
  {
    ...
    files: [
      { name: "bpadashAdm Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "bpadashAdm Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "bpadashAdm Logo.Zip", size: "2.02 MB", link: "#" },
